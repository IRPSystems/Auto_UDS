...
#Standard_Identifiers.script CanConfig_103.script Faults_Configuration.script Network_F1D5.script Network_Missmatch_F1D3.script Network_TimeOut_F1D2.script Routine_Control.script TrueDriveManager.script Generetic_ECU_Read.script
#UdsClient_CL.exe 51 UPP /s Standard_Identifiers.script CanConfig_103.script Faults_Configuration.script Network_F1D5.script Network_Missmatch_F1D3.script Network_TimeOut_F1D2.script Routine_Control.script TrueDriveManager.script Generetic_ECU_Read.script
