...
EXPECTED_ORDER = [
    ("MCU_STD_DID_List_2", "Standard Identifiers", "F180", "Boot Software Identification"),
    ...
    ("Unknown", "Standard Identifiers", "F192", "ECU Hardware Number"),
    ("Unknown", "Standard Identifiers", "F194", "ECU Software Number"),
    ("MCU_STD_DID_List_25", "Standard Identifiers", "0200", "Boot Flag"),
]

# Comprehensive Req. ID mapping without hardcoded statuses
REQ_ID_MAPPING = {
    "Standard Identifiers": {
        "Boot Software Identification": ("MCU_STD_DID_List_2", "F180"),
        "Application Software Identification": ("MCU_STD_DID_List_3", "F181"),
        "Application Data Identification": ("MCU_STD_DID_List_4", "F182"),
        "Vehicle Manufacturer spare part number": ("MCU_STD_DID_List_5", "F187"),
        "System Supplier Identifier": ("MCU_STD_DID_List_6", "F18A"),
        "ECU Manufacturing Date": ("MCU_STD_DID_List_7", "F18B"),
        "ECU Serial Number": ("MCU_STD_DID_List_8", "F18C"),
        "VIN-Vehicle Identification Number": ("MCU_STD_DID_List_9", "F190"),
        "System Supplier ECU Hardware Version Number": ("MCU_STD_DID_List_11", "F193"),
        "System Name/Engine Type": ("MCU_STD_DID_List_14", "F195"),
        "Repair Shop Code/Tester Serial Number": ("MCU_STD_DID_List_15", "F197"),
        "Programming Date": ("MCU_STD_DID_List_16", "F198"),
        "ECU Installation Date": ("MCU_STD_DID_List_17", "F199"),
        "System Supplier part number": ("MCU_STD_DID_List_18", "F1F0"),
        "Model number": ("MCU_STD_DID_List_19", "0100"),
        "Variant Code": ("MCU_STD_DID_List_20", "0101"),
        "Feature Code": ("MCU_STD_DID_List_21", "0102"),
        "HISTORY ZONE": ("MCU_STD_DID_List_24", "0201"),
        "Boot Flag": ("MCU_STD_DID_List_25", "0200"),
        "ECU Calibration Data": ("Unknown", "F1BE"),
        "ECU Hardware Number": ("Unknown", "F192"),
        "ECU Software Number": ("Unknown", "F194"),
    ...
    "Faults Configuration": {
        ...
        "CAN Transceiver Communication Healing Time": ("MCU_Fun_ID_List_1", "078F"),
